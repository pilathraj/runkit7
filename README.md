...
[![Build status (Windows)](https://ci.appveyor.com/api/projects/status/ryuel9t2r62i4gvg/branch/master?svg=true)](https://ci.appveyor.com/project/pilathraj/runkit7-2-fixed/branch/master)
